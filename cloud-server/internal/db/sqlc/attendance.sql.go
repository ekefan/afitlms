...
type CreateLectureAttendanceParams struct {
	...
	StudentSchID   string    `json:"student_sch_id"`
...
SELECT session_id, student_sch_id, attendance_time, attended, created_at FROM lecture_attendance
WHERE session_id = $1
`
...
SELECT id, course_code, lecturer_sch_id, session_date, created_at FROM lecture_sessions
WHERE course_code = $1
`
