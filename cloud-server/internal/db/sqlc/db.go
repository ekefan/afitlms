...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getActiveLecturerStmt, err = db.PrepareContext(ctx, getActiveLecturer); err != nil {
		return nil, fmt.Errorf("error preparing query GetActiveLecturer: %w", err)
	}
	...
	if q.getLecturerForAttendanceStmt, err = db.PrepareContext(ctx, getLecturerForAttendance); err != nil {
		return nil, fmt.Errorf("error preparing query GetLecturerForAttendance: %w", err)
	}
	...
	if q.getStudentsForAttendanceStmt, err = db.PrepareContext(ctx, getStudentsForAttendance); err != nil {
		return nil, fmt.Errorf("error preparing query GetStudentsForAttendance: %w", err)
	}
	...
	if q.updateLecturerAvailabilityStmt, err = db.PrepareContext(ctx, updateLecturerAvailability); err != nil {
		return nil, fmt.Errorf("error preparing query UpdateLecturerAvailability: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getActiveLecturerStmt != nil {
		if cerr := q.getActiveLecturerStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getActiveLecturerStmt: %w", cerr)
		}
	}
	...
	if q.getLecturerForAttendanceStmt != nil {
		if cerr := q.getLecturerForAttendanceStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getLecturerForAttendanceStmt: %w", cerr)
		}
	}
	...
	if q.getStudentsForAttendanceStmt != nil {
		if cerr := q.getStudentsForAttendanceStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getStudentsForAttendanceStmt: %w", cerr)
		}
	}
	...
	if q.updateLecturerAvailabilityStmt != nil {
		if cerr := q.updateLecturerAvailabilityStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updateLecturerAvailabilityStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	getActiveLecturerStmt                       *sql.Stmt
	...
	updateLecturerAvailabilityStmt              *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getActiveLecturerStmt:                       q.getActiveLecturerStmt,
		...
		getLecturerForAttendanceStmt:                q.getLecturerForAttendanceStmt,
		...
		getStudentsForAttendanceStmt:                q.getStudentsForAttendanceStmt,
		...
		updateLecturerAvailabilityStmt:              q.updateLecturerAvailabilityStmt,
